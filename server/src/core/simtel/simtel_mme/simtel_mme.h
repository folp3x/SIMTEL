...
#include "core/simtel/pcrf/simtel_pcrf/simtel_pcrf.h"
#include "core/simtel/register/simtel_register/simtel_register.h"
#include "core/simtel/smsc/simtel_smsc/simtel_smsc.h"
#include "core/simtel/visitor_list/simtel_visitor_list/simtel_visitor_list.h"
...
private:
  ...
  handleAttachRequestMTimsi(const common::imsi_t &mTimsi,
                            const common::imsi_t &realImsi,
                            const common::imei_t &imei, unsigned int mmeId);

  std::expected<common::imsi_t, std::string>
  handleAttachRequestImsi(const common::imsi_t &imsi,
