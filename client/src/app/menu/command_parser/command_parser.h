...
#include "app/menu/menu_item/menu_item_received/menu_item_received.h"
#include "app/menu/menu_item/menu_item_sent/menu_item_sent.h"

#include "app/menu/menu_item/menu_item_ussd/menu_item_ussd.h"
...
private:
  ...
  static std::expected<char, std::string>
  parseSpeedDialNum(const std::string &arg);

  static std::expected<common::msisdn_t, std::string>
  parseMsisdn(const std::string &arg);
